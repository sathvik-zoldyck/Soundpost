...
Console.WriteLine("Soundpost audio probe — reading Windows audio endpoints");
Console.WriteLine("===================================================");
...
Console.WriteLine("  dotnet run --project tools/Soundpost.Probe -- switch \"<deviceId>\"");
Console.WriteLine("  dotnet run --project tools/Soundpost.Probe -- route <pid> \"<deviceId>\"");
Console.WriteLine("  dotnet run --project tools/Soundpost.Probe -- unroute <pid>");
